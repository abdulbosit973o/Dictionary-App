...
import uz.gita.dictionary_app.presentation.adapter.WordAdapter
import uz.gita.dictionary_app.R
import uz.gita.dictionary_app.databinding.FragmentHomeNavBinding
...
class HomeFragment : Fragment(R.layout.fragment_home_nav), HomeContract.View {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.navView.setNavigationItemSelectedListener {
            when (it.itemId) {
                ...
                R.id.share -> {
                    ...
                    val shareBody = "Download on google play\n\nhttps://play.google.com/store/apps/details?id=org.telegram.messenger"
                ...
                R.id.privacy_police -> {
                    startActivity(Intent(Intent.ACTION_VIEW, Uri.parse("https://www.freeprivacypolicy.com/live/74d714b7-2013-4936-a5ed-02b50f32ec6a")))
                    binding.drawerLayout.closeDrawer(GravityCompat.START)
                }
                R.id.like -> {
                    try {
        ...
        binding.appBarMain.textLanguage.text = "Eng Uz Dictionary"
